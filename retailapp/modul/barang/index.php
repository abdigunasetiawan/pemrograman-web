                ...
                <form action="modul/barang/proses.php?aksi=tambah" method="post">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="pemasok" required>
                                ...
                                while ($row_pemasok = $result_pemasok->fetch_assoc()) {
                                    ?>
                                    <option value="<?= $row_pemasok['id_pemasok']; ?>"><?= $row_pemasok['nama_pemasok']; ?>
                                    </option>
                                    <?php
                                }
                                ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_barang" class="form-control" placeholder="Contoh : Pensil"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="ukuran" class="form-control" placeholder="Contoh : Sedang"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kategori" class="form-select">
                                ...
                                while ($row_kategori = $result_kategori->fetch_assoc()) {
                                    ?>
                                    <option value="<?= $row_kategori['id_kategori']; ?>">
                                        <?= $row_kategori['nama_kategori']; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="harga_beli" class="form-control" placeholder="Contoh : 5000"
                                required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="harga_jual">Harga Jual</label>
                            <input type="number" name="harga_jual" class="form-control" placeholder="Contoh : 7000"
                                required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="deskripsi">Deskripsi</label>
                            <input type="text" name="deskripsi" class="form-control" placeholder="Contoh : Barang baru"
                                required>
                        </div>
                    </div>
    ...
    <tbody>
        ...
        while ($row_barang = $result_barang->fetch_assoc()) {
            ...
            <tr>
                ...
                <td>
                    <a href="" data-bs-toggle="modal" data-bs-target="#modalEdit<?= $row_barang['id_barang']; ?>"
                        class="text-info"><i class="bi bi-pencil-square"></i></a>
                    <div class="modal fade" id="modalEdit<?= $row_barang['id_barang']; ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="modul/barang/proses.php?aksi=edit&id=<?= $row_barang['id_barang']; ?>"
                                    method="post">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label class="form-label" for="pemasok">Pemasok</label>
                                            <select class="form-select" name="pemasok" required>
                                                ...
                                                while ($row_pemasok = $result_pemasok->fetch_assoc()) {
                                                    ...
                                                    <option value="<?= $row_pemasok['id_pemasok']; ?>"
                                                        <?= $row_barang['id_pemasok'] == $row_pemasok['id_pemasok'] ? 'selected' : ''; ?>>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nama_barang" class="form-control"
                                                placeholder="Contoh : Pensil" value="<?= $row_barang['nama_barang']; ?>"
                                                required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="merk">Merk</label>
                                            <input type="text" name="merk" class="form-control" placeholder="Contoh : Abc"
                                                value="<?= $row_barang['merk']; ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="ukuran">Ukuran</label>
                                            <input type="text" name="ukuran" class="form-control"
                                                placeholder="Contoh : Sedang" value="<?= $row_barang['ukuran']; ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="satuan">Satuan</label>
                                            <input type="text" name="satuan" class="form-control" placeholder="Contoh : Pcs"
                                                value="<?= $row_barang['satuan']; ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="kategori">Kategori</label>
                                            <select name="kategori" class="form-select">
                                                ...
                                                while ($row_kategori = $result_kategori->fetch_assoc()) {
                                                    ?>
                                                    <option value="<?= $row_kategori['id_kategori']; ?>"
                                                        <?= $row_barang['id_kategori'] == $row_kategori['id_kategori'] ? 'selected' : ''; ?>>
                                                        <?= $row_kategori['nama_kategori']; ?></option>
                                                    <?php
                                                }
                                                ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="harga_beli" class="form-control"
                                                placeholder="Contoh : 5000" value="<?= $row_barang['harga_beli']; ?>"
                                                required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="harga_jual">Harga Jual</label>
                                            <input type="number" name="harga_jual" class="form-control"
                                                placeholder="Contoh : 7000" value="<?= $row_barang['harga_jual']; ?>"
                                                required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="deskripsi">Deskripsi</label>
                                            <input type="text" name="deskripsi" class="form-control"
                                                placeholder="Contoh : Barang baru"
                                                value="<?= $row_barang['deskripsi_barang']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                    ...
                    <a href="" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $row_barang['id_barang']; ?>"
                        class="text-danger"><i class="bi bi-trash-fill"></i></a>
                    <div class="modal fade" id="modalHapus<?= $row_barang['id_barang']; ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <form action="modul/barang/proses.php?aksi=hapus&id=<?= $row_barang['id_barang']; ?>"
                                        method="post">
