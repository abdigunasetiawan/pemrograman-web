...
<body class="min-h-screen flex  justify-center items-center bg-slate-50">
    ...
    <div class="bg-white shadow-md p-8 flex flex-col ">
        ...
        <form class="mt-4" action="<?= 'proses.php?action=edit&id=' . $_GET['id'] ?>" method="post">
            ...
            <input type="submit" value="Update" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-4 w-full dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
        </form>
    </div>
