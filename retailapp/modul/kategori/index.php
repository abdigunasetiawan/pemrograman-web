    ...
    <tbody>
        ...
        while ($row_kategori = $result_kategori->fetch_assoc()) {
            ...
            <tr>
                ...
                <td><span
                        class="badge <?= $row_kategori['status'] == 1 ? 'text-bg-success' : 'text-bg-danger'; ?>"><?= $row_kategori['status'] == 1 ? 'Aktif' : 'Tidak Aktif'; ?></span>
                </td>
                <td>
                    ...
                    <div class="modal fade" id="modalEdit<?= $row_kategori['id_kategori']; ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="modul/kategori/proses.php?aksi=edit&id=<?= $row_kategori['id_kategori']; ?>"
                                    method="post">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label class="form-label" for="namakategori">Nama Kategori</label>
                                            <input class="form-control" type="text" name="namakategori"
                                                ...
                                                value="<?= $row_kategori['nama_kategori']; ?>" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label" for="statu">Status</label>
                                            <select class="form-select" name="status">
                                                <option value="" selected disabled>Pilih Status</option>
                                                <option value="1" <?= $row_kategori['status'] == 1 ? 'selected' : ''; ?>>Aktif
                                                </option>
                                                <option value="0" <?= $row_kategori['status'] == 0 ? 'selected' : ''; ?>>Tidak Aktif
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="modal fade" id="modalHapus<?= $row_kategori['id_kategori']; ?>" tabindex="-1"
                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <form
                                        action="modul/kategori/proses.php?aksi=hapus&id=<?= $row_kategori['id_kategori']; ?>"
                                        method="post">
