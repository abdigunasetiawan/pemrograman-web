                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <select name="barang" class="form-select">
                                ...
                                while ($row_barang = $result_barang->fetch_assoc()) {
                                    ?>
                                    <option value="<?= $row_barang['id_barang']; ?>"><?= $row_barang['nama_barang']; ?>
                                    </option>
                                    <?php
                                }
                                ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="deskripsi" class="form-control"
                                placeholder="Contoh : Masuk barang baru" />
                        </div>
                    </div>
            ...
            <tr>
                ...
                <td>
                    <a class="text-decoration-none" href="" data-bs-toggle="modal"
                        data-bs-target="#modalMasuk<?= $row_persediaan['id_persediaan']; ?>">
                        <i class="bi bi-clipboard2-plus-fill"></i>
                    </a>
                    <!-- Modal -->
                    <div class="modal fade" id="modalMasuk<?= $row_persediaan['id_persediaan']; ?>" tabindex="-1"
                            ...
                            <div class="modal-content">
                                ...
                                <form
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="barang" class="form-label">Barang</label>
                                            <input class="form-control bg-secondary-subtle" type="text" name="barang"
