                ...
                <form action="modul/pemasok/proses.php?aksi=tambah" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="telepon" placeholder="Masukkan telepon"
                                required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="modal fade" id="modalEdit<?= $row_pemasok['id_pemasok']; ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="modul/pemasok/proses.php?aksi=edit&id=<?= $row_pemasok['id_pemasok']; ?>"
                                    method="post">
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label class="form-label" for="namapemasok">Nama Pemasok</label>
                    ...
                    <div class="modal fade" id="modalHapus<?= $row_pemasok['id_pemasok']; ?>" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <form action="modul/pemasok/proses.php?aksi=hapus&id=<?= $row_pemasok['id_pemasok']; ?>"
                                        method="post">
