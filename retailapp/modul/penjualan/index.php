                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="simpanPenjualan" type="button" class="btn btn-primary"
                                onclick="simpanPenjualan()">Proses</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mb-3">
            ...
            <select name="barang" id="barang" class="form-select" onchange="pilihBarang()">
                ...
                while ($row_barang = $result_barang->fetch_assoc()) {
                    ?>
                    <option value="<?= $row_barang['id_barang'] ?>" nama-barang="<?= $row_barang['nama_barang'] ?>"
                        data-stok="<?= $row_barang['stok_akhir'] ?>" data-harga="<?= $row_barang['harga_jual'] ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-between">
                                <span>Rp.</span>
                                <span><?= number_format($row_penjualan['totalbayar'], 0, ',', '.') ?></span>
                            </div>
                        </td>
                        <td>
                            <div class="d-flex justify-content-between">
                        ...
                        <td>
                            <div class="d-flex justify-content-between">
                                <span>Rp.</span>
                                <span><?= number_format($row_penjualan['kembalian'], 0, ',', '.') ?></span>
                            </div>
                        </td>
                        <td>
                            <a class="btn btn-primary btn-sm"
                                href="?modul=penjualan&aksi=detail&id=<?= $row_penjualan['id_penjualan']; ?>">
